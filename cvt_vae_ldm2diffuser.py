...
import re
import sys
sys.path.append('~/workspace/latent-diffusion/ldm/models')
from autoencoder import AutoencoderKL

model_cfg = {
    "ckpt_path": "~/workspace/latent-diffusion/logs/2024-05-21T19-34-36_autoencoder_kl_f8_ft/checkpoints/epoch=000006.ckpt",
...
if __name__=="__main__":
    diff_model_path = "~/.cache/huggingface/hub/models--stabilityai--sd-vae-ft-ema/snapshots/f04b2c4b98319346dad8c65879f680b1997b204a"
